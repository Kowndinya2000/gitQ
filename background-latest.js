...
function source(project_id,repo_name)
{
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() 
    {
      if (this.readyState == 4 && this.status == 200) 
      {
          ...
          {
              request1 = true
              source_metrics = response[1].split(",");
              document.getElementById('f1').innerHTML = source_metrics[0]
              document.getElementById('f1').style.background = '#feb60a'
              document.getElementById('f2').innerHTML = source_metrics[1]
              document.getElementById('f2').style.background = '#feb60a'
              
  
              document.getElementById('f3').innerHTML = source_metrics[4]
              document.getElementById('f3').style.background = '#ff0062'
              document.getElementById('f4').innerHTML = source_metrics[5]
              document.getElementById('f4').style.background = '#ff0062'
              
              document.getElementById('f5').innerHTML = source_metrics[2]
              document.getElementById('f5').style.background = '#44CC11'
              document.getElementById('f6').innerHTML = source_metrics[3]
    ...
    xhttp.open("POST","https://services.iittp.ac.in/gitq/source","true");
    xhttp.setRequestHeader('Content-type', "application/x-www-form-urlencoded");
    xhttp.send('source='+project_id+","+repo_name);
}

function open_bugs(project_id,repo_name,repo_url)
{
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() 
    {
      if (this.readyState == 4 && this.status == 200) 
      {
          ...
          {
              request2 = true
              var bugs_open = response[1];
              var xhttp_closed = new XMLHttpRequest();
              xhttp_closed.onreadystatechange = function() 
              {
                if (this.readyState == 4 && this.status == 200) 
                {
                    response_closed = this.responseText.split(":");
                    if(response_closed[0] == "True")
                    {
                        request3 = true
                        var bugs_closed = response_closed[1];
                        document.getElementById('bugs').style.background = '#ff0062'
                        document.getElementById('bugs').innerHTML = bugs_open + " : " + bugs_closed
                        if(request1 == true && request2 == true && request3 == true && request4 == true && request5 == true)
                        {
                            delete_repository(project_id);
                        }
              ...
              xhttp_closed.open("POST","https://services.iittp.ac.in/gitq/closed","true");
              xhttp_closed.setRequestHeader('Content-type', "application/x-www-form-urlencoded");
              xhttp_closed.send('closed='+project_id+","+repo_name+","+repo_url);
    ...
    xhttp.open("POST","https://services.iittp.ac.in/gitq/open","true");
    xhttp.setRequestHeader('Content-type', "application/x-www-form-urlencoded");
    xhttp.send('open='+project_id+","+repo_name+","+repo_url);
}

function efficiency(project_id,repo_name)
{
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() 
    {
      if (this.readyState == 4 && this.status == 200) 
      {
          ...
          {
              request4 = true
              var impacted_loc = (parseFloat(response[1]).toFixed(2)).toString();
              var impacted_files = (parseFloat(response[2]).toFixed(2)).toString();
              document.getElementById('impacted_files').innerHTML = impacted_files + "%"
              document.getElementById('impacted_files').style.background = '#feb60a'
              document.getElementById('impacted_loc').innerHTML = impacted_loc + "%"
    ...
    xhttp.open("POST","https://services.iittp.ac.in/gitq/efficiency","true");
    xhttp.setRequestHeader('Content-type', "application/x-www-form-urlencoded");
    xhttp.send('efficiency='+project_id+","+repo_name);
}

function active(project_id,repo_name)
{
    var xhttp = new XMLHttpRequest();
    xhttp.onreadystatechange = function() 
    {
      if (this.readyState == 4 && this.status == 200) 
      {
          ...
          {
              request5 = true
              var active_rate = (parseFloat(response[2]).toFixed(2)).toString();
              document.getElementById('active').innerHTML = active_rate + "%"
    ...
    xhttp.open("POST","https://services.iittp.ac.in/gitq/active","true");
    xhttp.setRequestHeader('Content-type', "application/x-www-form-urlencoded");
    xhttp.send('active='+project_id+","+repo_name);
}
...
{
    document.getElementsByClassName("flex-shrink-0 col-12 col-md-9 mb-4 mb-md-0")[0].innerHTML = loading_buffer+entire_code ; 
    url_split = repo_url.split("/");
    repo_url = url_split[0] + "/" + url_split[1] + "/" + url_split[2] + "/" + url_split[3] + "/" + url_split[4] ;
                ...
                box-shadow: 1px 1px 20px green;
                  ...
                  background: #FFFFFF;background: #8A9AF7;transition: 0.3s;margin-left:0.5rem;margin-right:0.5rem;">
                     ...
                     document.getElementsByClassName("flex-shrink-0 col-12 col-md-9 mb-4 mb-md-0")[0].innerHTML = badges_final + entire_code ;
                      ...
                      open_bugs(project_id,repo_name,repo_url);
                      active(project_id,repo_name); 
                      efficiency(project_id,repo_name);
                      source(project_id,repo_name);
          }
    ...
    xhttp.open("POST", "https://services.iittp.ac.in/gitq/download", true);
    xhttp.setRequestHeader('Content-type', "application/x-www-form-urlencoded")
    xhttp.send('url='+repo_url);
}
